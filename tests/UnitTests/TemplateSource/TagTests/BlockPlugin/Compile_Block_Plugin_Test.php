...
class CompileBlockPluginTest extends PHPUnit_Smarty
{
    ...
    {
        $this->smarty->registerPlugin(\Smarty\Smarty::PLUGIN_BLOCK, 'blockpluginstatic', ['myblockclass1', 'staticfunc']);
    ...
    public function testBlockPluginRegisteredMethod()
    {
        ...
        $this->smarty->registerPlugin(\Smarty\Smarty::PLUGIN_BLOCK, 'blockpluginmethod', [$object, 'methodfunc']);
    ...
    {
        $object = new myblockclass1();
        $this->smarty->registerObject('myobject', $object, [], true, ['objectfunc']);
    ...
    public function testCache(
        ...
        $this->smarty->registerFilter('pre', [$this, 'prefilterTest']);
    ...
    {
        return [[false, false, false, 1, 1, 1, 1, false, 0, 'no cacheing'],
                     [false, false, false, 2, 1, 2, 2, false, 0, 'no cacheing'],
                     [false, false, true, 3, 3, 3, 3, false, 1, 'cacheable'],
                     [false, true, true, 4, 4, 4, 4, false, 1, 'cachable Caching'],
                     [true, true, true, 5, 4, 4, 4, false, 1, 'cachable isCached'],
                     [true, true, true, 6, 4, 4, 4, false, 1, 'cachable isCached'],
                     [false, true, false, 7, 7, 7, 7, false, 2, 'not cachable'],
                     [true, true, false, 8, 7, 7, 8, false, 2, 'not cachable isCached'],
                     [true, true, false, 9, 7, 7, 9, false, 2, 'not cachable isCached'],
                     [false, true, true, 10, 10, 10, 10, true, 3, 'not cachable nocache var'],
                     [true, true, true, 11, 10, 10, 11, true, 3, 'not cachable isCached'],
                     [true, true, true, 12, 10, 10, 12, true, 3, 'not cachable isCached'],];
    }
  ...
  */
    public function dataTestNocacheSpacing()
    {
        ...
        /*
                    ...
                    * test number
                    */
        return [["A{testparameter value=\$bar}\n{\$foo}{/testparameter}C", 'AbarC', 'Var1', $i++],
                     ["A{testparameter value=\$bar}\n{\$foo}\n{/testparameter}C", "Abar\nC", 'Var2', $i++],
                     ["A{testparameter value=\$bar}\n{\$foo}{/testparameter}\nC", 'AbarC', 'Var3', $i++],
...
class myblockclass1
{
    public static function staticfunc($params, $content, $smarty_tpl, &$repeat)
    {
        if (!$repeat) {
