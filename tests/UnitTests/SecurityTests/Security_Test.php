...
class SecurityTest extends PHPUnit_Smarty
{
    ...
    {
        $this->smarty->security_policy->allowed_tags = ['counter'];
    ...
    public function testDisabledTags()
    {
        ...
        $this->smarty->security_policy->disabled_tags = ['cycle'];
        $this->smarty->fetch('string:{counter}{cycle values="1,2"}');
    }
    ...
    public function testAllowedModifier1()
    {
        ...
        $this->smarty->security_policy->allowed_modifiers = ['capitalize'];
    ...
    {
        $this->smarty->security_policy->allowed_modifiers = ['upper'];
    ...
    public function testDisabledModifier()
    {
        ...
        $this->smarty->security_policy->disabled_modifiers = ['lower'];
        $this->smarty->fetch('string:{"hello"|upper}{"world"|lower}');
    }
    ...
    {
        $this->smarty->security_policy->secure_dir = ['.' . DIRECTORY_SEPARATOR . 'templates_2' . DIRECTORY_SEPARATOR];
    ...
    public function testNotTrustedDirectory()
    {
        ...
        $this->smarty->security_policy->secure_dir = [str_replace('\\', '/', __DIR__ . '/templates_3/')];
    ...
    {
        $this->smarty->security_policy->static_classes = ['mysecuritystaticclass'];
    ...
    public function testTemplateTrustedStream()
    {
        ...
        fclose($fp);
        $this->smarty->security_policy->streams = ['global'];
    ...
    public function testTemplateNotTrustedStream()
    {
        ...
        fwrite($fp, 'hello world {$foo}');
        fclose($fp);
        $this->smarty->security_policy->streams = ['notrusted'];
        $tpl = $this->smarty->createTemplate('global:mytest');
        $this->assertTrue($tpl->getSource()->exists);
        stream_wrapper_unregister('global');
    }
