 ...
 *
 */
class Section extends Foreach_Section
{
    /**
     ...
     * @var string
     */
    protected $tag_name = 'section';
    /**
     * Valid properties of $smarty.section.name.xxx variable
     *
     * @var array
     */
    protected $name_properties = ['first', 'last', 'index', 'iteration', 'show', 'total', 'rownum', 'index_prev', 'index_next', 'loop'];
    /**
    ...
    public function compile($args, \Smarty\Compiler\Template $compiler, $parameter = [], $tag = null, $function = null): string
    {
        ...
        $this->open_tag($compiler, 'section', ['section', $compiler->tag_nocache]);
        $init_local = [];
        $init_named_property = [];
        $init_for = [];
        $inc_for = [];
        ...
        $output .= "{$section_var} = new \\Smarty\\Variable({$_vars});\n";
