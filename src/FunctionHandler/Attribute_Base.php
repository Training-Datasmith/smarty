 ...
 */
abstract class Attribute_Base implements Attribute_Function_Handler_Interface
{
    /**
    ...
    {
        return ['required_attributes' => $this->required_attributes, 'optional_attributes' => $this->optional_attributes, 'shorttag_order' => $this->shorttag_order, 'option_flags' => $this->option_flags];
    }
}